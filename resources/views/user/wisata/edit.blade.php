...
<div class="container-fluid">
 ...
 <div class="card p-4 mb-4">
    <h5 class="font-weight-bold p-0 m-0">Edit Wisata</h5>
  </div>
 ...
 <!-- Content Row -->
  <div class="card p-4 mb-4 col-lg-12">
    @if (session()->has('error'))
      ...
      @endif
    <form action="{{ route('user.wisata.update', $wisata->id) }}" method="POST" enctype="multipart/form-data">
      @method('PUT')
      @csrf
      <div class="row">
        ...
        <div class="form-group col-md-6 mb-4">
          <label>Status</label>
          <select name="status" id="" class="form-control @error('status') is-invalid @enderror" readonly disabled>
